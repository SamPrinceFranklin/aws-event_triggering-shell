...
# Date  : 2023 06 05
# Description : This script will create a S3 bucket and upload a file to the bucket.
#               It will create a Lambda function and add permissions to the Lambda function.
#               It will create an S3 event trigger for the Lambda function.
#               It will create an SNS topic and add permissions to the Lambda function to publish to the SNS topic.
#               It will publish a message to the SNS topic.
#######################
# Usage : ./s3-notification-triggers.sh
#######################
# Note : This script requires jq to be installed on the system.
...
bucket_name="sam-prince-franklin-s3-bucket-shell"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="samprince.franklink2020@vitstudent.ac.in"
...
aws sns publish \
  ...
  --message "Hello, A new object has been created in s3 bucket. Please check."
